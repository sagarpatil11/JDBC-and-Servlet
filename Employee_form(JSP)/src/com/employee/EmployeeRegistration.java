...
public class EmployeeRegistration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			...
			PreparedStatement preparedstatement=connection.prepareStatement("insert into employee_details(emp_name,email,address,comp_name,age,gender,specialized,languages,salary,User_ID) values(?,?,?,?,?,?,?,?,?,?)");
