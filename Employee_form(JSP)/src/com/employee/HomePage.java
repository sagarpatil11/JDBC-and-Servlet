...
public class HomePage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		printwriter.println("<body><ul class='header_ul'><li class='header_li' style='float: right;'><a href='Logout'>Logout</a></li>");
		printwriter.println("<li class='header_li'><h2>Employee Forum</h2></li>");
		printwriter.println("<li class='header_li' style='padding:20px 0px 20px 10px; float:right;'>Hi! "+ username+"</li></ul>");
